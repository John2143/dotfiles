let
  ...
  steam = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIKdcyW41sxBMhX4fgXKGJckajKD7g+6mE3NjlfujXiKn john@steam";
...
in {
  ...
  # Env vars for the timestone lobby watcher on the steam VM (one NAME=value
