...
/interface bridge
add admin-mac=D0:EA:11:6B:75:F3 ageing-time=5m arp=enabled arp-timeout=auto \
...
set [ find default-name=ether1 ] advertise="10M-baseT-half,10M-baseT-full,100M\
    ...
    loop-protect-send-interval=5s mac-address=D0:EA:11:6B:75:F3 mtu=1500 \
    name=ether1 orig-mac-address=D0:EA:11:6B:75:F3 rx-flow-control=off \
    tx-flow-control=off
set [ find default-name=sfp-sfpplus1 ] advertise="10M-baseT-half,10M-baseT-ful\
    ...
    D0:EA:11:6B:75:F4 mtu=1500 name=sfp-sfpplus1 orig-mac-address=\
    D0:EA:11:6B:75:F4 rx-flow-control=off sfp-ignore-rx-los=no \
...
set [ find default-name=sfp-sfpplus2 ] advertise="10M-baseT-half,10M-baseT-ful\
    ...
    unlimited/unlimited disabled=no l2mtu=1592 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    D0:EA:11:6B:75:F5 mtu=1500 name=sfp-sfpplus2 orig-mac-address=\
    D0:EA:11:6B:75:F5 rx-flow-control=off sfp-ignore-rx-los=no \
    sfp-rate-select=high sfp-shutdown-temperature=95C tx-flow-control=off
set [ find default-name=sfp-sfpplus3 ] advertise="10M-baseT-half,10M-baseT-ful\
    ...
    unlimited/unlimited disabled=no l2mtu=1592 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    D0:EA:11:6B:75:F6 mtu=1500 name=sfp-sfpplus3 orig-mac-address=\
    D0:EA:11:6B:75:F6 rx-flow-control=off sfp-ignore-rx-los=no \
    sfp-rate-select=high sfp-shutdown-temperature=95C tx-flow-control=off
set [ find default-name=sfp-sfpplus4 ] advertise="10M-baseT-half,10M-baseT-ful\
    ...
    unlimited/unlimited disabled=no l2mtu=1592 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    D0:EA:11:6B:75:F7 mtu=1500 name=sfp-sfpplus4 orig-mac-address=\
    D0:EA:11:6B:75:F7 rx-flow-control=off sfp-ignore-rx-los=no \
    sfp-rate-select=high sfp-shutdown-temperature=95C tx-flow-control=off
/queue interface
...
add address=192.168.5.5/24 disabled=no interface=bridge network=192.168.5.0
/ip cloud
