# 2026-09-17 23:23:04 by RouterOS 7.19.6
# software id = UL5S-M34T
#
# model = CRS310-8G+2S+
# serial number = HKG0AJ14YM5
/interface bridge
add admin-mac=04:F4:1C:E7:24:3C ageing-time=5m arp=enabled arp-timeout=auto \
...
set [ find default-name=ether1 ] advertise="10M-baseT-half,10M-baseT-full,100M\
    ...
    loop-protect-send-interval=5s mac-address=04:F4:1C:E7:24:3C mtu=1500 \
    name=ether1 orig-mac-address=04:F4:1C:E7:24:3C rx-flow-control=off \
    tx-flow-control=off
set [ find default-name=ether2 ] advertise="10M-baseT-half,10M-baseT-full,100M\
    -baseT-half,100M-baseT-full,1G-baseT-full,2.5G-baseT" arp=enabled \
    arp-timeout=auto auto-negotiation=yes bandwidth=unlimited/unlimited \
    disabled=no l2mtu=1592 loop-protect=default loop-protect-disable-time=5m \
    loop-protect-send-interval=5s mac-address=04:F4:1C:E7:24:3D mtu=1500 \
    name=ether2 orig-mac-address=04:F4:1C:E7:24:3D rx-flow-control=off \
    tx-flow-control=off
set [ find default-name=ether3 ] advertise="10M-baseT-half,10M-baseT-full,100M\
    -baseT-half,100M-baseT-full,1G-baseT-full,2.5G-baseT" arp=enabled \
    arp-timeout=auto auto-negotiation=yes bandwidth=unlimited/unlimited \
    disabled=no l2mtu=1592 loop-protect=default loop-protect-disable-time=5m \
    loop-protect-send-interval=5s mac-address=04:F4:1C:E7:24:3E mtu=1500 \
    name=ether3 orig-mac-address=04:F4:1C:E7:24:3E rx-flow-control=off \
    tx-flow-control=off
set [ find default-name=ether4 ] advertise="10M-baseT-half,10M-baseT-full,100M\
    -baseT-half,100M-baseT-full,1G-baseT-full,2.5G-baseT" arp=enabled \
    arp-timeout=auto auto-negotiation=yes bandwidth=unlimited/unlimited \
    disabled=no l2mtu=1592 loop-protect=default loop-protect-disable-time=5m \
    loop-protect-send-interval=5s mac-address=04:F4:1C:E7:24:3F mtu=1500 \
    name=ether4 orig-mac-address=04:F4:1C:E7:24:3F rx-flow-control=off \
    tx-flow-control=off
set [ find default-name=ether5 ] advertise="10M-baseT-half,10M-baseT-full,100M\
    -baseT-half,100M-baseT-full,1G-baseT-full,2.5G-baseT" arp=enabled \
    arp-timeout=auto auto-negotiation=yes bandwidth=unlimited/unlimited \
    disabled=no l2mtu=1592 loop-protect=default loop-protect-disable-time=5m \
    loop-protect-send-interval=5s mac-address=04:F4:1C:E7:24:40 mtu=1500 \
    name=ether5 orig-mac-address=04:F4:1C:E7:24:40 rx-flow-control=off \
    tx-flow-control=off
set [ find default-name=ether6 ] advertise="10M-baseT-half,10M-baseT-full,100M\
    -baseT-half,100M-baseT-full,1G-baseT-full,2.5G-baseT" arp=enabled \
    arp-timeout=auto auto-negotiation=yes bandwidth=unlimited/unlimited \
    disabled=no l2mtu=1592 loop-protect=default loop-protect-disable-time=5m \
    loop-protect-send-interval=5s mac-address=04:F4:1C:E7:24:41 mtu=1500 \
    name=ether6 orig-mac-address=04:F4:1C:E7:24:41 rx-flow-control=off \
    tx-flow-control=off
set [ find default-name=ether7 ] advertise="10M-baseT-half,10M-baseT-full,100M\
    -baseT-half,100M-baseT-full,1G-baseT-full,2.5G-baseT" arp=enabled \
    arp-timeout=auto auto-negotiation=yes bandwidth=unlimited/unlimited \
    disabled=no l2mtu=1592 loop-protect=default loop-protect-disable-time=5m \
    loop-protect-send-interval=5s mac-address=04:F4:1C:E7:24:42 mtu=1500 \
    name=ether7 orig-mac-address=04:F4:1C:E7:24:42 rx-flow-control=off \
    tx-flow-control=off
set [ find default-name=ether8 ] advertise="10M-baseT-half,10M-baseT-full,100M\
    -baseT-half,100M-baseT-full,1G-baseT-full,2.5G-baseT" arp=enabled \
    arp-timeout=auto auto-negotiation=yes bandwidth=unlimited/unlimited \
    disabled=no l2mtu=1592 loop-protect=default loop-protect-disable-time=5m \
    loop-protect-send-interval=5s mac-address=04:F4:1C:E7:24:43 mtu=1500 \
    name=ether8 orig-mac-address=04:F4:1C:E7:24:43 rx-flow-control=off \
    tx-flow-control=off
set [ find default-name=sfp-sfpplus1 ] advertise="10M-baseT-half,10M-baseT-ful\
    ...
    04:F4:1C:E7:24:44 mtu=1500 name=sfp-sfpplus1 orig-mac-address=\
    04:F4:1C:E7:24:44 rx-flow-control=off sfp-ignore-rx-los=no \
...
set [ find default-name=sfp-sfpplus2 ] advertise="10M-baseT-half,10M-baseT-ful\
    ...
    unlimited/unlimited disabled=no l2mtu=1592 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    04:F4:1C:E7:24:45 mtu=1500 name=sfp-sfpplus2 orig-mac-address=\
    04:F4:1C:E7:24:45 rx-flow-control=off sfp-ignore-rx-los=no \
    sfp-rate-select=high sfp-shutdown-temperature=95C tx-flow-control=off
/queue interface
...
set ether2 !egress-rate-queue0 !egress-rate-queue1 !egress-rate-queue2 \
    !egress-rate-queue3 !egress-rate-queue4 !egress-rate-queue5 \
    !egress-rate-queue6 !egress-rate-queue7 map=default profile=default \
    trust-l2=ignore trust-l3=ignore tx-manager=default
set ether3 !egress-rate-queue0 !egress-rate-queue1 !egress-rate-queue2 \
    !egress-rate-queue3 !egress-rate-queue4 !egress-rate-queue5 \
    !egress-rate-queue6 !egress-rate-queue7 map=default profile=default \
    trust-l2=ignore trust-l3=ignore tx-manager=default
set ether4 !egress-rate-queue0 !egress-rate-queue1 !egress-rate-queue2 \
    !egress-rate-queue3 !egress-rate-queue4 !egress-rate-queue5 \
    !egress-rate-queue6 !egress-rate-queue7 map=default profile=default \
    trust-l2=ignore trust-l3=ignore tx-manager=default
set ether5 !egress-rate-queue0 !egress-rate-queue1 !egress-rate-queue2 \
    !egress-rate-queue3 !egress-rate-queue4 !egress-rate-queue5 \
    !egress-rate-queue6 !egress-rate-queue7 map=default profile=default \
    trust-l2=ignore trust-l3=ignore tx-manager=default
set ether6 !egress-rate-queue0 !egress-rate-queue1 !egress-rate-queue2 \
    !egress-rate-queue3 !egress-rate-queue4 !egress-rate-queue5 \
    !egress-rate-queue6 !egress-rate-queue7 map=default profile=default \
    trust-l2=ignore trust-l3=ignore tx-manager=default
set ether7 !egress-rate-queue0 !egress-rate-queue1 !egress-rate-queue2 \
    !egress-rate-queue3 !egress-rate-queue4 !egress-rate-queue5 \
    !egress-rate-queue6 !egress-rate-queue7 map=default profile=default \
    trust-l2=ignore trust-l3=ignore tx-manager=default
set ether8 !egress-rate-queue0 !egress-rate-queue1 !egress-rate-queue2 \
    !egress-rate-queue3 !egress-rate-queue4 !egress-rate-queue5 \
    !egress-rate-queue6 !egress-rate-queue7 map=default profile=default \
    trust-l2=ignore trust-l3=ignore tx-manager=default
...
set enabled=no
/ip address
add address=192.168.5.2/24 comment=defconf disabled=no interface=bridge \
    network=192.168.5.0
/ip cloud
...
set address-list-extra-time=0s allow-remote-requests=yes cache-max-ttl=1w \
    ...
    servers=1.1.1.1 use-doh-server="" verify-doh-cert=no vrf=main
