# 2026-09-17 23:22:59 by RouterOS 7.20.8
# software id = BFGZ-NVN3
#
# model = CRS305-1G-4S+
# serial number = HMC0B8ZZ7F2
/interface bridge
add admin-mac=D0:EA:11:70:B9:EB ageing-time=5m arp=enabled arp-timeout=auto \
...
set [ find default-name=ether1 ] advertise="10M-baseT-half,10M-baseT-full,100M\
    ...
    loop-protect-send-interval=5s mac-address=D0:EA:11:70:B9:EB mtu=1500 \
    name=ether1 orig-mac-address=D0:EA:11:70:B9:EB rx-flow-control=off \
    tx-flow-control=off
set [ find default-name=sfp-sfpplus1 ] advertise="10M-baseT-half,10M-baseT-ful\
    ...
    unlimited/unlimited disabled=no l2mtu=1592 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    D0:EA:11:70:B9:EC mtu=1500 name=sfp-sfpplus1 orig-mac-address=\
    D0:EA:11:70:B9:EC rx-flow-control=off sfp-ignore-rx-los=no \
...
set [ find default-name=sfp-sfpplus2 ] advertise="10M-baseT-half,10M-baseT-ful\
    ...
    unlimited/unlimited disabled=no l2mtu=1592 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    D0:EA:11:70:B9:ED mtu=1500 name=sfp-sfpplus2 orig-mac-address=\
    D0:EA:11:70:B9:ED rx-flow-control=off sfp-ignore-rx-los=no \
    sfp-rate-select=high sfp-shutdown-temperature=95C tx-flow-control=off
set [ find default-name=sfp-sfpplus3 ] advertise="10M-baseT-half,10M-baseT-ful\
    l,100M-baseT-half,100M-baseT-full,1G-baseT-half,1G-baseT-full,1G-baseX,2.5\
    G-baseT,2.5G-baseX,5G-baseT,10G-baseT,10G-baseSR-LR,10G-baseCR" arp=\
    enabled arp-timeout=auto auto-negotiation=yes bandwidth=\
    unlimited/unlimited disabled=no l2mtu=1592 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    D0:EA:11:70:B9:EE mtu=1500 name=sfp-sfpplus3 orig-mac-address=\
    D0:EA:11:70:B9:EE rx-flow-control=off sfp-ignore-rx-los=no \
    sfp-rate-select=high sfp-shutdown-temperature=95C tx-flow-control=off
set [ find default-name=sfp-sfpplus4 ] advertise="10M-baseT-half,10M-baseT-ful\
    l,100M-baseT-half,100M-baseT-full,1G-baseT-half,1G-baseT-full,1G-baseX,2.5\
    G-baseT,2.5G-baseX,5G-baseT,10G-baseT,10G-baseSR-LR,10G-baseCR" arp=\
    enabled arp-timeout=auto auto-negotiation=yes bandwidth=\
    unlimited/unlimited disabled=no l2mtu=1592 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    D0:EA:11:70:B9:EF mtu=1500 name=sfp-sfpplus4 orig-mac-address=\
    D0:EA:11:70:B9:EF rx-flow-control=off sfp-ignore-rx-los=no \
    sfp-rate-select=high sfp-shutdown-temperature=95C tx-flow-control=off
/queue interface
set bridge queue=no-queue
/interface ethernet switch
set 0 l3-hw-offloading=no mirror-target=none name=switch1 qos-hw-offloading=\
    no rspan=no rspan-egress-vlan-id=1 rspan-ingress-vlan-id=1
...
set 4 !egress-rate !ingress-rate l3-hw-offloading=yes limit-broadcasts=yes \
    limit-unknown-multicasts=no limit-unknown-unicasts=no mirror-egress=no \
    mirror-ingress=no storm-rate=100
set 5 !egress-rate !ingress-rate limit-broadcasts=yes \
    limit-unknown-multicasts=no limit-unknown-unicasts=no mirror-egress=no \
    mirror-ingress=no storm-rate=100
...
set ether1 !egress-rate-queue0 !egress-rate-queue1 !egress-rate-queue2 \
...
set sfp-sfpplus1 !egress-rate-queue0 !egress-rate-queue1 !egress-rate-queue2 \
    !egress-rate-queue3 !egress-rate-queue4 !egress-rate-queue5 \
    !egress-rate-queue6 !egress-rate-queue7 map=default profile=default \
    trust-l2=ignore trust-l3=ignore tx-manager=default
set sfp-sfpplus2 !egress-rate-queue0 !egress-rate-queue1 !egress-rate-queue2 \
    ...
    !egress-rate-queue6 !egress-rate-queue7 map=default profile=default \
    trust-l2=ignore trust-l3=ignore tx-manager=default
set sfp-sfpplus3 !egress-rate-queue0 !egress-rate-queue1 !egress-rate-queue2 \
    !egress-rate-queue3 !egress-rate-queue4 !egress-rate-queue5 \
    !egress-rate-queue6 !egress-rate-queue7 map=default profile=default \
    trust-l2=ignore trust-l3=ignore tx-manager=default
set sfp-sfpplus4 !egress-rate-queue0 !egress-rate-queue1 !egress-rate-queue2 \
    !egress-rate-queue3 !egress-rate-queue4 !egress-rate-queue5 \
    !egress-rate-queue6 !egress-rate-queue7 map=default profile=default \
    trust-l2=ignore trust-l3=ignore tx-manager=default
...
set builtin-trust-anchors=trusted crl-download=no crl-store=ram crl-use=no
/console settings
...
add auto-isolate=no bpdu-guard=no bridge=bridge broadcast-flood=yes comment=\
    defconf disabled=no edge=auto fast-leave=no frame-types=admit-all \
    horizon=none hw=yes ingress-filtering=yes interface=sfp-sfpplus2 \
    !internal-path-cost learn=auto multicast-router=temporary-query \
    mvrp-applicant-state=normal-participant mvrp-registrar-state=normal \
    !path-cost point-to-point=auto priority=0x80 pvid=1 restricted-role=no \
    restricted-tcn=no tag-stacking=no trusted=no unknown-multicast-flood=yes \
...
add auto-isolate=no bpdu-guard=no bridge=bridge broadcast-flood=yes comment=\
    defconf disabled=no edge=auto fast-leave=no frame-types=admit-all \
    horizon=none hw=yes ingress-filtering=yes interface=sfp-sfpplus3 \
    !internal-path-cost learn=auto multicast-router=temporary-query \
    mvrp-applicant-state=normal-participant mvrp-registrar-state=normal \
    !path-cost point-to-point=auto priority=0x80 pvid=1 restricted-role=no \
    restricted-tcn=no tag-stacking=no trusted=no unknown-multicast-flood=yes \
...
add auto-isolate=no bpdu-guard=no bridge=bridge broadcast-flood=yes comment=\
    defconf disabled=no edge=auto fast-leave=no frame-types=admit-all \
    horizon=none hw=yes ingress-filtering=yes interface=sfp-sfpplus4 \
    !internal-path-cost learn=auto multicast-router=temporary-query \
    mvrp-applicant-state=normal-participant mvrp-registrar-state=normal \
    !path-cost point-to-point=auto priority=0x80 pvid=1 restricted-role=no \
    restricted-tcn=no tag-stacking=no trusted=no unknown-multicast-flood=yes \
...
set neigh-discovery-burst-delay=300ms neigh-discovery-burst-limit=64 \
    ...
    route-index-delay-min=1s route-queue-limit-high=256 \
    route-queue-limit-low=0 shwp-reset-counter=128
...
set mirror-buffers=10% multicast-buffers=10% shared-buffers=40%
...
set enabled=no
/ip address
add address=192.168.5.4/24 comment=defconf disabled=no interface=bridge \
    network=192.168.5.0
add address=192.168.1.250/24 comment=temp-recovery disabled=no interface=\
    bridge network=192.168.1.0
/ip cloud
...
set 0 disabled=no interface=sfp-sfpplus1 leds=sfp-sfpplus1-led1 type=\
    interface-activity
set 1 disabled=no interface=sfp-sfpplus2 leds=sfp-sfpplus2-led1 type=\
    interface-activity
set 2 disabled=no interface=sfp-sfpplus3 leds=sfp-sfpplus3-led1 type=\
    interface-activity
set 3 disabled=no interface=sfp-sfpplus4 leds=sfp-sfpplus4-led1 type=\
    interface-activity
...
/system ntp client
set enabled=yes mode=unicast servers=162.159.200.1,216.239.35.12 vrf=main
/system ntp server
...
set sfp-sfpplus3 disabled=yes
set sfp-sfpplus4 disabled=yes
...
set address-acquisition-mode=dhcp-with-fallback allow-from=0.0.0.0/0 \
    allow-from-ports=p1,p2,p3,p4,p5 allow-from-vlan=0 identity=Mikrotik \
