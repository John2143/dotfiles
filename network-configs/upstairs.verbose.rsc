# 2026-09-17 23:23:01 by RouterOS 7.19.6
# software id = KNIM-QKB7
#
# model = CRS310-8G+2S+
# serial number = HKG0AVERD3V
/interface bridge
add admin-mac=04:F4:1C:E6:7C:0C ageing-time=5m arp=enabled arp-timeout=auto \
...
set [ find default-name=ether1 ] advertise="10M-baseT-half,10M-baseT-full,100M\
    ...
    loop-protect-send-interval=5s mac-address=04:F4:1C:E6:7C:0C mtu=1500 \
    name=ether1 orig-mac-address=04:F4:1C:E6:7C:0C rx-flow-control=off \
    tx-flow-control=off
set [ find default-name=ether2 ] advertise="10M-baseT-half,10M-baseT-full,100M\
    -baseT-half,100M-baseT-full,1G-baseT-full,2.5G-baseT" arp=enabled \
    arp-timeout=auto auto-negotiation=yes bandwidth=unlimited/unlimited \
    disabled=no l2mtu=1592 loop-protect=default loop-protect-disable-time=5m \
    loop-protect-send-interval=5s mac-address=04:F4:1C:E6:7C:0D mtu=1500 \
    name=ether2 orig-mac-address=04:F4:1C:E6:7C:0D rx-flow-control=off \
    tx-flow-control=off
set [ find default-name=ether3 ] advertise="10M-baseT-half,10M-baseT-full,100M\
    -baseT-half,100M-baseT-full,1G-baseT-full,2.5G-baseT" arp=enabled \
    arp-timeout=auto auto-negotiation=yes bandwidth=unlimited/unlimited \
    disabled=no l2mtu=1592 loop-protect=default loop-protect-disable-time=5m \
    loop-protect-send-interval=5s mac-address=04:F4:1C:E6:7C:0E mtu=1500 \
    name=ether3 orig-mac-address=04:F4:1C:E6:7C:0E rx-flow-control=off \
    tx-flow-control=off
set [ find default-name=ether4 ] advertise="10M-baseT-half,10M-baseT-full,100M\
    -baseT-half,100M-baseT-full,1G-baseT-full,2.5G-baseT" arp=enabled \
    arp-timeout=auto auto-negotiation=yes bandwidth=unlimited/unlimited \
    disabled=no l2mtu=1592 loop-protect=default loop-protect-disable-time=5m \
    loop-protect-send-interval=5s mac-address=04:F4:1C:E6:7C:0F mtu=1500 \
    name=ether4 orig-mac-address=04:F4:1C:E6:7C:0F rx-flow-control=off \
    tx-flow-control=off
set [ find default-name=ether5 ] advertise="10M-baseT-half,10M-baseT-full,100M\
    -baseT-half,100M-baseT-full,1G-baseT-full,2.5G-baseT" arp=enabled \
    arp-timeout=auto auto-negotiation=yes bandwidth=unlimited/unlimited \
    disabled=no l2mtu=1592 loop-protect=default loop-protect-disable-time=5m \
    loop-protect-send-interval=5s mac-address=04:F4:1C:E6:7C:10 mtu=1500 \
    name=ether5 orig-mac-address=04:F4:1C:E6:7C:10 rx-flow-control=off \
    tx-flow-control=off
set [ find default-name=ether6 ] advertise="10M-baseT-half,10M-baseT-full,100M\
    -baseT-half,100M-baseT-full,1G-baseT-full,2.5G-baseT" arp=enabled \
    arp-timeout=auto auto-negotiation=yes bandwidth=unlimited/unlimited \
    disabled=no l2mtu=1592 loop-protect=default loop-protect-disable-time=5m \
    loop-protect-send-interval=5s mac-address=04:F4:1C:E6:7C:11 mtu=1500 \
    name=ether6 orig-mac-address=04:F4:1C:E6:7C:11 rx-flow-control=off \
    tx-flow-control=off
set [ find default-name=ether7 ] advertise="10M-baseT-half,10M-baseT-full,100M\
    -baseT-half,100M-baseT-full,1G-baseT-full,2.5G-baseT" arp=enabled \
    arp-timeout=auto auto-negotiation=yes bandwidth=unlimited/unlimited \
    disabled=no l2mtu=1592 loop-protect=default loop-protect-disable-time=5m \
    loop-protect-send-interval=5s mac-address=04:F4:1C:E6:7C:12 mtu=1500 \
    name=ether7 orig-mac-address=04:F4:1C:E6:7C:12 rx-flow-control=off \
    tx-flow-control=off
set [ find default-name=ether8 ] advertise="10M-baseT-half,10M-baseT-full,100M\
    -baseT-half,100M-baseT-full,1G-baseT-full,2.5G-baseT" arp=enabled \
    arp-timeout=auto auto-negotiation=yes bandwidth=unlimited/unlimited \
    disabled=no l2mtu=1592 loop-protect=default loop-protect-disable-time=5m \
    loop-protect-send-interval=5s mac-address=04:F4:1C:E6:7C:13 mtu=1500 \
    name=ether8 orig-mac-address=04:F4:1C:E6:7C:13 rx-flow-control=off \
    tx-flow-control=off
set [ find default-name=sfp-sfpplus1 ] advertise="10M-baseT-half,10M-baseT-ful\
    ...
    04:F4:1C:E6:7C:14 mtu=1500 name=sfp-sfpplus1 orig-mac-address=\
    04:F4:1C:E6:7C:14 rx-flow-control=off sfp-ignore-rx-los=no \
...
set [ find default-name=sfp-sfpplus2 ] advertise="10M-baseT-half,10M-baseT-ful\
    ...
    unlimited/unlimited disabled=no l2mtu=1592 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    04:F4:1C:E6:7C:15 mtu=1500 name=sfp-sfpplus2 orig-mac-address=\
    04:F4:1C:E6:7C:15 rx-flow-control=off sfp-ignore-rx-los=no \
    sfp-rate-select=high sfp-shutdown-temperature=95C tx-flow-control=off
/queue interface
...
set enabled=no
/ip address
add address=192.168.5.3/24 comment=defconf disabled=no interface=bridge \
    network=192.168.5.0
/ip cloud
